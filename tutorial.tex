...
\autor{
	...
	\\[0.5cm] 
	Vítor Estêvão Silva Souza\thanks{``Professor Ph.D.''\url{vitor.souza@ufes.br}} }
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/Partial4}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/Partial2}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/Partial5}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/Partial3}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/menu3}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/menu4}
	\caption{Propriedades da relação de agregação}
	\label{fig:menu4}
\end{figure}

\subsection{Exemplos}
As Figuras \ref{fig:exemplo1}, \ref{fig:exemplo2} e \ref{fig:exemplo3} mostram exemplos de modelagem com essas novas adições.

\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/exemplo1}
	\caption{Exemplo}
	\label{fig:exemplo1}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/exemplo2}
	\caption{Exemplo}
	\label{fig:exemplo2}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figuras/exemplo3}
	\caption{Exemplo}
	\label{fig:exemplo3}
\end{figure}
